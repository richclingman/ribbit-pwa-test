...
var ASM_CONSTS = {
 ...
 138096: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 138179: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 138248: () => { return window.innerWidth; },  
 138278: () => { return window.innerHeight; }
};
